...
export default function FestivalsPage() {
  ...
  return (
    <div className="min-h-full pb-24 px-4 sm:px-6 bg-transparent text-gray-905 dark:text-gray-200 relative transition-colors duration-300">
      
      {/* Unified Single Row Header */}
      <header className="sticky top-0 z-40 bg-[#FCF8F2]/95 dark:bg-[#0A0503]/95 backdrop-blur-md -mx-4 sm:-mx-6 px-4 sm:px-6 py-3.5 mb-8 border-b border-gray-200 dark:border-white/5 flex items-center justify-between gap-2 md:gap-4 transition-colors duration-300">
